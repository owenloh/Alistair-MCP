...
_LOAD_CONTEXT_DOC = (
    ...
    "Returns who Alistair is (persona + voice), how to route what {user} says to the right "
    ...
    "memory block of what you already know about {user}. Read-only."
)
_DAILY_BRIEF_DOC = (
...
_SAVE_REFERENCE_DOC = (
    "Append a reference to {user}'s Notion References Tray (the 'Unorganised References' page) "
    "when they say 'add to tray', 'save this reference', etc. INSERT-ONLY and safe: it reads the "
...
_PROJECT_CONTEXT_DOC = (
    ...
    "GitHub side of the daily brief: it fishes the live detail {user}'s Notion project pages link "
