...
The single source of truth for what Alistair remembers about {owner}. `save` is the
...
_SAVE_DOC = (
    "Save one durable fact about {owner} to long-term memory. Use this whenever you "
    ...
    "{owner} likes things done), 'action' (an open item/commitment), or 'summary' (a "
...
_GET_DOC = (
    "Load what you remember about {owner} as a compact, ready-to-read block. Call this "
...
def memory_maintenance() -> dict:
    ...
    return {
        ...
        "guardrails": "Never invent facts. Ask {owner} before deleting personal data you're unsure "
